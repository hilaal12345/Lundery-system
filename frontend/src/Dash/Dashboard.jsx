  ...
  return (
   ...
   <h2 className="text-2xl font-bold mb-6 text-white">Dashboard</h2> 
      <ul className="flex flex-col gap-3">
        ...
        <Link to="/Service Display"><li className="p-2 rounded-md hover:bg-gray-200 cursor-pointer transition"> <i className="fa-brands fa-product-hunt text-xl"></i>Service</li></Link>
       {/* <Link to="/registerproduct"><li className="p-2 rounded-md hover:bg-gray-200 cursor-pointer transition"> <i className="fa-brands fa-product-hunt text-xl"></i>Add Product</li></Link> */}
        <li className="p-2 rounded-md hover:bg-gray-200 cursor-pointer transition"><i className="fa-solid fa-user text-xl"></i>Customer</li>
