...
//               <th className="py-3 px-4 text-left text-gray-600 font-semibold">service Name</th>
...
//               <th className="py-3 px-4 text-left text-gray-600 font-semibold">Kg</th>
...
//                 <img
//                   src={`http://localhost:3000/allImages/${items. prImage}`}
//                   alt="Iphone"
