  ...
  return (
   ...
   <h2 className="text-2xl font-bold mb-6 text-white">Dashboard</h2> 
      <ul className="flex flex-col gap-3">
        ...
        <Link to="/Add Service"><li className="p-2 rounded-md hover:bg-gray-200 cursor-pointer transition"> <i className="fa-brands fa-product-hunt text-xl"></i>Service</li></Link>       
